<script lang="ts">
	...
	import { AddUser, DeleteUser, EditUser } from '$lib/widgets';
...
<HeadTitle title="Inactive Users" />
	...
	<div class="card" id="ordersTable">
		<div class="card-body">
			<div class="flex items-center gap-3 mb-4">
				<h4 class="text-15 grow">Inactive Users</h4>
				<button
					type="button"
								...
								<tr>
									...
									<td class="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
										<div class="flex gap-2">
											{#if hasPermission(data.authUser.permissions, PermissionTypes.Update, Modules.Users)}
												<a
													href="/users/{user._id}"
											...
											{#if hasPermission(data.authUser.permissions, PermissionTypes.Update, Modules.Users)}
												...
												>
											{/if}
											{#if hasPermission(data.authUser.permissions, PermissionTypes.Delete, Modules.Users)}
												<button
