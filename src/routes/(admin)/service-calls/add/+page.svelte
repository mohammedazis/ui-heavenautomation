<script lang="ts">
	...
	import { HeadTitle, Breadcrumb, LucideIcon, CustomerSelect, Modal } from '$lib/components';
	import { enhance } from '$app/forms';
	import ServicesSelect from '$lib/components/ServicesSelect.svelte';
		...
		<div class="card-body">
			...
			>
				<div class="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-12">
					<CustomerSelect bind:mobileNumber customerId="" />
					...
					<ServicesSelect serviceId="" serviceName="" />
