...
<HeadTitle title="Add Installation" />

<div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto relative">
	<Breadcrumb title="Create Installations" pagetitle="Heaven Automation" name="Installations" />
		...
		<div class="card-body">
			...
			>
				<div class="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-12">
					<CustomerSelect bind:mobileNumber />
					...
					<!-- <div class="xl:col-span-6">
						...
						<p class="mt-1 text-sm text-slate-400 dark:text-zink-200">
							Enter the Name for Further References
						</p>
					</div> -->
