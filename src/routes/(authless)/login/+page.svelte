<script lang="ts">
	...
	import { HeadTitle } from '$lib/components';
	...
	>
		<div class="!px-10 !py-12 card-body">
			...
			<div class="mt-8 text-center">
				...
				<p class="text-slate-500 dark:text-zink-200">Sign in to continue to G Media.</p>
			</div>

			<form class="mt-10" method="POST" use:enhance>
				<div class="mb-3">
